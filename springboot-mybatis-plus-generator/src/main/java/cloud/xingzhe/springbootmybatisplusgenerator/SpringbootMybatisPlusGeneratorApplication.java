package cloud.xingzhe.springbootmybatisplusgenerator;
 ...
 * @return
 */
    private static void focListAddOutputFile(String projectPath, PackageConfig pc, String templatePath, List<FileOutConfig> focList) {
    ...
    private static void setFileCreate(String projectPath, InjectionConfig cfg) {
 ...
 */
    private static PackageConfig getPackageConfig(AutoGenerator mpg) {
        ...
        pc.setParent("cloud.xingzhe.generator");
